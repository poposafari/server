...
CREATE TABLE db.ingame_pokedex (
  account_id INTEGER PRIMARY KEY REFERENCES db.account(id) ON DELETE CASCADE,
  gen_1 VARCHAR(20)[] NOT NULL DEFAULT '{}'::VARCHAR(20)[],
  gen_2 VARCHAR(20)[] NOT NULL DEFAULT '{}'::VARCHAR(20)[],
  gen_3 VARCHAR(20)[] NOT NULL DEFAULT '{}'::VARCHAR(20)[],
  gen_4 VARCHAR(20)[] NOT NULL DEFAULT '{}'::VARCHAR(20)[],
  gen_5 VARCHAR(20)[] NOT NULL DEFAULT '{}'::VARCHAR(20)[],
  gen_6 VARCHAR(20)[] NOT NULL DEFAULT '{}'::VARCHAR(20)[],
  gen_7 VARCHAR(20)[] NOT NULL DEFAULT '{}'::VARCHAR(20)[],
  gen_8 VARCHAR(20)[] NOT NULL DEFAULT '{}'::VARCHAR(20)[],
  gen_9 VARCHAR(20)[] NOT NULL DEFAULT '{}'::VARCHAR(20)[]
);
