export enum AppErrorCode {
  ...
  SAFARI_TICKET_NOT_FOUND = 'SAFARI_TICKET_NOT_FOUND',
  SAFARI_TICKET_NOT_READY = 'SAFARI_TICKET_NOT_READY',
  ...
  POKEMON_TIER_MAX = 'POKEMON_TIER_MAX',
  POKEMON_LEVEL_NOT_ENOUGH = 'POKEMON_LEVEL_NOT_ENOUGH',
...
export enum AppErrorMessage {
  ...
  ACCOUNT_IN_USE = 'Account is currently in use',
